...
\begin{document}
    ...
    \part{Infrastructure logicielle}
		...
		\subsubsection{Configuration}
		    ...
		    Il faut ensuite cr\'eer un utilisateur "<tpuser">, et lui allouer des droits de s\'election sur tout les machines du r\'eseau 10.192.10.0, afin de permettre l'acc\`es \`a la base "<projet_hd"> depuis une machine distante.

		    FICHIER CONFS/MYSQL/USERS.SQL
